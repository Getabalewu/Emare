...
export function Clubs() {
  ...
  const clubs = [
    ...
    },
    {
      ...
      category: 'Service',
      members: 42,
      description: 'Environmental conservation and sustainability initiatives on campus',
    ...
    },
    {
      ...
      category: 'Arts',
      members: 35,
      description: 'Musical performances, concerts, and music education programs',
      image: 'https://images.pexels.com/photos/3693120/pexels-photo-3693120.jpeg?auto=compress&cs=tinysrgb&w=400',
      events: 14,
      founded: '2016'
    }
  ]
    ...
    <div className="">
      <div className="">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Student Clubs
</h1>
